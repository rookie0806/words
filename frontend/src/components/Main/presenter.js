...
const TestButton = (props,context) => (
  <>
    { (
      ...
      <td id={"day"+(props.pnum*75 + props.word + 25*props.test)}  className={styles.bodys}>
        
      </td>
      <td id={"no"+(props.pnum*75 +props.word + 25*props.test)} className={styles.bodys}>
      </td>
      <td id={"word"+ (props.pnum*75 +props.word + 25*props.test)} className={styles.bodys}>
      </td>
      <td id={"kor"+ (props.pnum*75 +props.word + 25*props.test)}  className={styles.bodys}>
